...
const styles = StyleSheet.create({
  ...
  avatarFallbackText: { color: '#FFF', fontSize: 32, fontWeight: '900' },
  cameraBtn: {
    position: 'absolute',
    right: -2,
    bottom: 2,
  ...
  identityInfo: { flex: 1, paddingTop: 1 },
  identityName: {
    color: '#FFFFFF',
    fontSize: 23,
    lineHeight: 27,
  ...
  statValue: { color: '#FFF', fontSize: 20, fontWeight: '900', marginBottom: 1 },
  statEmoji: { fontSize: 14, marginLeft: 4, marginTop: 1 },
  statLabel: { color: '#7D7989', fontSize: 9, textTransform: 'uppercase', fontWeight: '800', letterSpacing: 0.5 },
  statDivider: { width: 1, height: 24, backgroundColor: 'rgba(255,255,255,0.07)' },
